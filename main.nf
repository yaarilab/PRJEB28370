...
Channel.value(params.mate).into{g_1_mate_g_55;g_1_mate_g_87;g_1_mate_g_92;g_1_mate_g9_0;g_1_mate_g9_5;g_1_mate_g9_7;g_1_mate_g38_11;g_1_mate_g38_9;g_1_mate_g38_12;g_1_mate_g22_10;g_1_mate_g22_12;g_1_mate_g22_14;g_1_mate_g52_0;g_1_mate_g52_1;g_1_mate_g52_8;g_1_mate_g28_12;g_1_mate_g28_15;g_1_mate_g28_19;g_1_mate_g78_12;g_1_mate_g78_15;g_1_mate_g78_19}
if (params.reads){
Channel
...
output:
 set val(name), file("*_primers-pass.fast*")  into g38_11_reads0_g_55
...
output:
 set val(name),file("*_consensus-pass.fastq")  into g22_10_reads0_g_92
...
input:
 set val(name), file(reads) from g22_10_reads0_g_92
 val mate from g_1_mate_g_92

output:
 set val(name), file("*pair-pass.fastq")  into g_92_reads0_g28_12
...
input:
 set val(name),file(reads) from g_92_reads0_g28_12
...
output:
 set val(name), file("*_primers-pass.fast*")  into g56_11_reads0_g_59
 set val(name), file("*_primers-fail.fast*") optional true  into g56_11_reads_failed11
...
fasta = params.Mask_Primer_C_region_MaskPrimers.fasta
...
output:
 set val(name),  file("*_collapse-unique.fast*")  into g_70_reads0_g_76, g_70_reads0_g_71
...
output:
 ...
 set val(name),file("*_TCR*") optional true  into g_71_reads1_g_90

"""
#shell example: 

#!/bin/sh 
awk '/^>/{f=""; if(\$0 ~ "TRB"){f="${name}_TCR.fasta"} else {f="${name}_IG.fasta"}; print \$0 > f ; next } {print \$0 > f} ' ${reads}
"""
}


process split_constant_trb {

publishDir params.outdir, mode: 'copy', saveAs: {filename -> if (filename =~ /tra$/) "reads/$filename"}
publishDir params.outdir, mode: 'copy', saveAs: {filename -> if (filename =~ /trb$/) "reads/$filename"}
input:
 set val(name),file(reads) from g_71_reads1_g_90

output:
 file "tra" optional true  into g_90_germlineDb00
 file "trb" optional true  into g_90_germlineDb11
...
mkdir trb
mkdir tra
awk '/^>/{f=""; split(\$0,b,"PRIMER="); if(substr(b[2],1,3)=="TRA"){f="tra/${name}.fasta"} else {f="trb/${name}.fasta"}; print \$0 > f ; next } {print \$0 > f} ' ${reads}
"""
}
